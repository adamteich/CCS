function output = poker_simulation(alpha, beta, competitor_cards, competitor_actions, middle_cards, self_cards, starting_cash, bust_limit)
...
opponent_card_expected_value(1) = 2.5;
P_bluffing(1) = 1;
